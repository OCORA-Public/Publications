...
* For active collaboration (within the OCORA framework) the OCORA Code of Conduct and Member Agreement must be accepted ans signed. In In case of interest for active collaboration and you are a eligible to become a partner according to the OCORA Code of conduct please drop a "interest of becomming a OCORA member by mail" to (rolf.muehlemann2@sbb.ch).
